...
def get_data_e2e(trainfile, testfile, w2v_file, eelstmfile, maxlen):
    """
    Converts the input files  into the end2end model input formats
    :param the train tag file: produced by TaggingScheme-all.py
    :param the test tag file: produced by TaggingScheme-all.py
    ...
    pickle.dump([train, test, source_W, source_vob, sourc_idex_word, target_vob,
                 target_idex_word, max_s, k], open(eelstmfile, 'wb'))
