...
def train_e2e_model(eelstmfile, modelfile, resultdir, npochos,
    ...
    while(epoch < npochos):
        ...
        if epoch == saveepoch:
            resultfile = resultdir + "result2-" + str(saveepoch)
            saveepoch += save_inter
...
if __name__ == "__main__":
    ...
    e2edatafile = "./data/demo/result2/e2edata.pkl"
    modelfile = "./data/demo/result2/e2e_lstmb_model.pkl"
    resultdir = "./data/demo/result2/"
